...
var sankey_chart = anychart.sankey(sankey_data_enroll);//customizing the width of the nodes
sankey_chart.nodeWidth("50%");//setting the chart title
sankey_chart.title("Donor Tissue to Clinical Trial Phase using an MSC: Enroll");//customizing the vertical padding of the nodes
sankey_chart.nodePadding(20);//setting the container id
sankey_chart.container("container_enroll");//initiating drawing the Sankey diagram
sankey_chart.draw();});
